...
## Results - Models | Linear regression (2)
- <font size="4"> Cases vs. (A) GDP and (B) Pop density. Grouped by region. </font>
- <font size="4"> Significant slope estiamtes for GDP in Sub-Saharan Africa, pop density in Middle East & North Africa, and both GDP and pop density in the Americas & Carribean. </font>


```{r, echo = FALSE, out.height = "300px"}
knitr::include_graphics("../results/05_lm2_line_plot.png")
#knitr::include_graphics("../results/05_lm2_Est_plot1.png")
```
