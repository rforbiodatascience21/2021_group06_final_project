...
- <font size="4"> 2 linear regression models ($y=\beta_0 + \beta_1 x_1+ \beta_2 x_2 + \epsilon$): </font>
  *  <font size="4"> $x_1$ = Pop % above 65, $x_2$ = Urban pop %. Grouped by income level </font>
  * <font size="4"> $x_1$ = GDP, $x_2$ = Pop density. Grouped by region </font>
...
**We see that Covid "waves" are not synchronous between global regions.** 
 ...
 - <font size="4"> Some regions had very visually distinct peaks of waves over time (Europe & Central Asia), while other were less distinct (Asia & Pacific)</font>
 - <font size="4">  The region Europe & Central Asia had the highest percentage of countries in waves at a certen time. At the highest peak almost 70% of the countries in the region were in a wave.  </font>
